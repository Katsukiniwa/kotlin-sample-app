...
open class StatusByHost(
    ...
    companion object {
         ...
         */
        val STATUS_BY_HOST = StatusByHost()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, STATUS_BY_HOST, null)
