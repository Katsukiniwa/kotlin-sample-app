...
public class SetupInstruments extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, SetupInstrumentsTimed> TIMED = createField(DSL.name("TIMED"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(nu.studer.sample.performance_schema.enums.SetupInstrumentsTimed.class), this, "");
