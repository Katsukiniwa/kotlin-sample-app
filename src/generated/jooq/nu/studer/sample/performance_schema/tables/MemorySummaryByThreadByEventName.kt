...
open class MemorySummaryByThreadByEventName(
    ...
    companion object {
         ...
         */
        val MEMORY_SUMMARY_BY_THREAD_BY_EVENT_NAME = MemorySummaryByThreadByEventName()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, MEMORY_SUMMARY_BY_THREAD_BY_EVENT_NAME, null)
