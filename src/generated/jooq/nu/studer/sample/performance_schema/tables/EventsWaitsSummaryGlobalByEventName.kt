...
open class EventsWaitsSummaryGlobalByEventName(
    ...
    companion object {
         ...
         */
        val EVENTS_WAITS_SUMMARY_GLOBAL_BY_EVENT_NAME = EventsWaitsSummaryGlobalByEventName()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, EVENTS_WAITS_SUMMARY_GLOBAL_BY_EVENT_NAME, null)
