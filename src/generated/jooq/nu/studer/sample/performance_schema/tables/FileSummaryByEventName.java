...
public class FileSummaryByEventName extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> SUM_NUMBER_OF_BYTES_READ = createField(DSL.name("SUM_NUMBER_OF_BYTES_READ"), SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<Record, Long> SUM_NUMBER_OF_BYTES_WRITE = createField(DSL.name("SUM_NUMBER_OF_BYTES_WRITE"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    private FileSummaryByEventName(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private FileSummaryByEventName(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> FileSummaryByEventName(Table<O> child, ForeignKey<O, Record> key) {
