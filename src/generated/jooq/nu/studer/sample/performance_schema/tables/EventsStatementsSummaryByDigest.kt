...
open class EventsStatementsSummaryByDigest(
    ...
    companion object {
         ...
         */
        val EVENTS_STATEMENTS_SUMMARY_BY_DIGEST = EventsStatementsSummaryByDigest()
    }
     ...
     */
    val SCHEMA_NAME: TableField<Record, String?> = createField(DSL.name("SCHEMA_NAME"), SQLDataType.VARCHAR(64), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, EVENTS_STATEMENTS_SUMMARY_BY_DIGEST, null)
