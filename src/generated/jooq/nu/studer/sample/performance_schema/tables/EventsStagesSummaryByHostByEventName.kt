...
open class EventsStagesSummaryByHostByEventName(
    ...
    companion object {
         ...
         */
        val EVENTS_STAGES_SUMMARY_BY_HOST_BY_EVENT_NAME = EventsStagesSummaryByHostByEventName()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, EVENTS_STAGES_SUMMARY_BY_HOST_BY_EVENT_NAME, null)
