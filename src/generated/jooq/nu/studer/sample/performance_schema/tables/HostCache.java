...
public class HostCache extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, LocalDateTime> FIRST_ERROR_SEEN = createField(DSL.name("FIRST_ERROR_SEEN"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.inline("0000-00-00 00:00:00", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>performance_schema.host_cache.LAST_ERROR_SEEN</code>.
     */
    public final TableField<Record, LocalDateTime> LAST_ERROR_SEEN = createField(DSL.name("LAST_ERROR_SEEN"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.inline("0000-00-00 00:00:00", SQLDataType.LOCALDATETIME)), this, "");
