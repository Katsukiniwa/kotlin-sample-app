...
open class ReplicationApplierConfiguration(
    ...
    companion object {
         ...
         */
        val REPLICATION_APPLIER_CONFIGURATION = ReplicationApplierConfiguration()
    }
     ...
     */
    val DESIRED_DELAY: TableField<Record, Int?> = createField(DSL.name("DESIRED_DELAY"), SQLDataType.INTEGER.nullable(false), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, REPLICATION_APPLIER_CONFIGURATION, null)
