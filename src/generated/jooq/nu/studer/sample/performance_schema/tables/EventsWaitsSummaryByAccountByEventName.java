...
public class EventsWaitsSummaryByAccountByEventName extends TableImpl<Record> {
    ...
    private EventsWaitsSummaryByAccountByEventName(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsWaitsSummaryByAccountByEventName(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsWaitsSummaryByAccountByEventName(Table<O> child, ForeignKey<O, Record> key) {
