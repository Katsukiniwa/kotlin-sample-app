...
public class FileSummaryByInstance extends TableImpl<Record> {
    ...
    private FileSummaryByInstance(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private FileSummaryByInstance(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> FileSummaryByInstance(Table<O> child, ForeignKey<O, Record> key) {
