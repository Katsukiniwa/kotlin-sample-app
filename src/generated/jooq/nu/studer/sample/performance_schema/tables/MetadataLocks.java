...
public class MetadataLocks extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> LOCK_DURATION = createField(DSL.name("LOCK_DURATION"), SQLDataType.VARCHAR(32).nullable(false), this, "");
    ...
    private MetadataLocks(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private MetadataLocks(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> MetadataLocks(Table<O> child, ForeignKey<O, Record> key) {
