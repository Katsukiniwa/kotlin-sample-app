...
public class MemorySummaryByThreadByEventName extends TableImpl<Record> {
    ...
    private MemorySummaryByThreadByEventName(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private MemorySummaryByThreadByEventName(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> MemorySummaryByThreadByEventName(Table<O> child, ForeignKey<O, Record> key) {
