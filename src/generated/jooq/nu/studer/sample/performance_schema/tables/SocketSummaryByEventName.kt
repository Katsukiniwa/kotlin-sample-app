...
open class SocketSummaryByEventName(
    ...
    companion object {
         ...
         */
        val SOCKET_SUMMARY_BY_EVENT_NAME = SocketSummaryByEventName()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, SOCKET_SUMMARY_BY_EVENT_NAME, null)
