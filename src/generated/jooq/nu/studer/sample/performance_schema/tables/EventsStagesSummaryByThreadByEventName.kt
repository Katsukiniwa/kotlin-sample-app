...
open class EventsStagesSummaryByThreadByEventName(
    ...
    companion object {
         ...
         */
        val EVENTS_STAGES_SUMMARY_BY_THREAD_BY_EVENT_NAME = EventsStagesSummaryByThreadByEventName()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, EVENTS_STAGES_SUMMARY_BY_THREAD_BY_EVENT_NAME, null)
