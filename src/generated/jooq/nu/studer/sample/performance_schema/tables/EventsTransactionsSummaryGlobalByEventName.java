...
public class EventsTransactionsSummaryGlobalByEventName extends TableImpl<Record> {
    ...
    private EventsTransactionsSummaryGlobalByEventName(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsTransactionsSummaryGlobalByEventName(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsTransactionsSummaryGlobalByEventName(Table<O> child, ForeignKey<O, Record> key) {
