...
open class EventsTransactionsCurrent(
    ...
    companion object {
         ...
         */
        val EVENTS_TRANSACTIONS_CURRENT = EventsTransactionsCurrent()
    }
     ...
     */
    val STATE: TableField<Record, EventsTransactionsCurrentState?> = createField(DSL.name("STATE"), SQLDataType.VARCHAR(11).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsTransactionsCurrentState::class.java), this, "")
     ...
     */
    val ACCESS_MODE: TableField<Record, EventsTransactionsCurrentAccessMode?> = createField(DSL.name("ACCESS_MODE"), SQLDataType.VARCHAR(10).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsTransactionsCurrentAccessMode::class.java), this, "")
     ...
     */
    val AUTOCOMMIT: TableField<Record, EventsTransactionsCurrentAutocommit?> = createField(DSL.name("AUTOCOMMIT"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsTransactionsCurrentAutocommit::class.java), this, "")
     ...
     */
    val NESTING_EVENT_TYPE: TableField<Record, EventsTransactionsCurrentNestingEventType?> = createField(DSL.name("NESTING_EVENT_TYPE"), SQLDataType.VARCHAR(11).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsTransactionsCurrentNestingEventType::class.java), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, EVENTS_TRANSACTIONS_CURRENT, null)
