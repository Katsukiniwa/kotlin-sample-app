...
public class EventsStatementsSummaryByProgram extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, EventsStatementsSummaryByProgramObjectType> OBJECT_TYPE = createField(DSL.name("OBJECT_TYPE"), SQLDataType.VARCHAR(9).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsStatementsSummaryByProgramObjectType.class), this, "");
     ...
     */
    public final TableField<Record, ULong> COUNT_STATEMENTS = createField(DSL.name("COUNT_STATEMENTS"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.events_statements_summary_by_program.SUM_STATEMENTS_WAIT</code>.
     */
    public final TableField<Record, ULong> SUM_STATEMENTS_WAIT = createField(DSL.name("SUM_STATEMENTS_WAIT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.events_statements_summary_by_program.MIN_STATEMENTS_WAIT</code>.
     */
    public final TableField<Record, ULong> MIN_STATEMENTS_WAIT = createField(DSL.name("MIN_STATEMENTS_WAIT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.events_statements_summary_by_program.AVG_STATEMENTS_WAIT</code>.
     */
    public final TableField<Record, ULong> AVG_STATEMENTS_WAIT = createField(DSL.name("AVG_STATEMENTS_WAIT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.events_statements_summary_by_program.MAX_STATEMENTS_WAIT</code>.
     */
    public final TableField<Record, ULong> MAX_STATEMENTS_WAIT = createField(DSL.name("MAX_STATEMENTS_WAIT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
    ...
    private EventsStatementsSummaryByProgram(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsStatementsSummaryByProgram(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsStatementsSummaryByProgram(Table<O> child, ForeignKey<O, Record> key) {
