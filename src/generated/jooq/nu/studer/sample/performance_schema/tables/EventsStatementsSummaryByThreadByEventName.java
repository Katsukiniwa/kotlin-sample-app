...
public class EventsStatementsSummaryByThreadByEventName extends TableImpl<Record> {
    ...
    private EventsStatementsSummaryByThreadByEventName(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsStatementsSummaryByThreadByEventName(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsStatementsSummaryByThreadByEventName(Table<O> child, ForeignKey<O, Record> key) {
