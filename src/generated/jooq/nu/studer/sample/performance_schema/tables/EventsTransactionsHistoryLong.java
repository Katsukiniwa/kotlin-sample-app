...
import nu.studer.sample.performance_schema.enums.EventsTransactionsHistoryLongAccessMode;
import nu.studer.sample.performance_schema.enums.EventsTransactionsHistoryLongAutocommit;
import nu.studer.sample.performance_schema.enums.EventsTransactionsHistoryLongNestingEventType;
import nu.studer.sample.performance_schema.enums.EventsTransactionsHistoryLongState;
...
public class EventsTransactionsHistoryLong extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, EventsTransactionsHistoryLongState> STATE = createField(DSL.name("STATE"), SQLDataType.VARCHAR(11).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsTransactionsHistoryLongState.class), this, "");
     ...
     */
    public final TableField<Record, EventsTransactionsHistoryLongAccessMode> ACCESS_MODE = createField(DSL.name("ACCESS_MODE"), SQLDataType.VARCHAR(10).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsTransactionsHistoryLongAccessMode.class), this, "");
     ...
     */
    public final TableField<Record, EventsTransactionsHistoryLongAutocommit> AUTOCOMMIT = createField(DSL.name("AUTOCOMMIT"), SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsTransactionsHistoryLongAutocommit.class), this, "");
     ...
     */
    public final TableField<Record, EventsTransactionsHistoryLongNestingEventType> NESTING_EVENT_TYPE = createField(DSL.name("NESTING_EVENT_TYPE"), SQLDataType.VARCHAR(11).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsTransactionsHistoryLongNestingEventType.class), this, "");

    private EventsTransactionsHistoryLong(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsTransactionsHistoryLong(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsTransactionsHistoryLong(Table<O> child, ForeignKey<O, Record> key) {
