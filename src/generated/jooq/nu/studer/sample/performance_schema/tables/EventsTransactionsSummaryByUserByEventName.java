...
public class EventsTransactionsSummaryByUserByEventName extends TableImpl<Record> {
    ...
    private EventsTransactionsSummaryByUserByEventName(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsTransactionsSummaryByUserByEventName(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsTransactionsSummaryByUserByEventName(Table<O> child, ForeignKey<O, Record> key) {
