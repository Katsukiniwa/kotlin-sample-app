...
public class EventsStatementsSummaryByAccountByEventName extends TableImpl<Record> {
    ...
    private EventsStatementsSummaryByAccountByEventName(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsStatementsSummaryByAccountByEventName(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsStatementsSummaryByAccountByEventName(Table<O> child, ForeignKey<O, Record> key) {
