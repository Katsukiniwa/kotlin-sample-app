...
public class TableIoWaitsSummaryByTable extends TableImpl<Record> {
    ...
    private TableIoWaitsSummaryByTable(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private TableIoWaitsSummaryByTable(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> TableIoWaitsSummaryByTable(Table<O> child, ForeignKey<O, Record> key) {
