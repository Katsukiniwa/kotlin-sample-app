...
public class TableIoWaitsSummaryByIndexUsage extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, ULong> COUNT_FETCH = createField(DSL.name("COUNT_FETCH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.SUM_TIMER_FETCH</code>.
     */
    public final TableField<Record, ULong> SUM_TIMER_FETCH = createField(DSL.name("SUM_TIMER_FETCH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MIN_TIMER_FETCH</code>.
     */
    public final TableField<Record, ULong> MIN_TIMER_FETCH = createField(DSL.name("MIN_TIMER_FETCH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.AVG_TIMER_FETCH</code>.
     */
    public final TableField<Record, ULong> AVG_TIMER_FETCH = createField(DSL.name("AVG_TIMER_FETCH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MAX_TIMER_FETCH</code>.
     */
    public final TableField<Record, ULong> MAX_TIMER_FETCH = createField(DSL.name("MAX_TIMER_FETCH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.COUNT_INSERT</code>.
     */
    public final TableField<Record, ULong> COUNT_INSERT = createField(DSL.name("COUNT_INSERT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.SUM_TIMER_INSERT</code>.
     */
    public final TableField<Record, ULong> SUM_TIMER_INSERT = createField(DSL.name("SUM_TIMER_INSERT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MIN_TIMER_INSERT</code>.
     */
    public final TableField<Record, ULong> MIN_TIMER_INSERT = createField(DSL.name("MIN_TIMER_INSERT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.AVG_TIMER_INSERT</code>.
     */
    public final TableField<Record, ULong> AVG_TIMER_INSERT = createField(DSL.name("AVG_TIMER_INSERT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MAX_TIMER_INSERT</code>.
     */
    public final TableField<Record, ULong> MAX_TIMER_INSERT = createField(DSL.name("MAX_TIMER_INSERT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.COUNT_UPDATE</code>.
     */
    public final TableField<Record, ULong> COUNT_UPDATE = createField(DSL.name("COUNT_UPDATE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.SUM_TIMER_UPDATE</code>.
     */
    public final TableField<Record, ULong> SUM_TIMER_UPDATE = createField(DSL.name("SUM_TIMER_UPDATE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MIN_TIMER_UPDATE</code>.
     */
    public final TableField<Record, ULong> MIN_TIMER_UPDATE = createField(DSL.name("MIN_TIMER_UPDATE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.AVG_TIMER_UPDATE</code>.
     */
    public final TableField<Record, ULong> AVG_TIMER_UPDATE = createField(DSL.name("AVG_TIMER_UPDATE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MAX_TIMER_UPDATE</code>.
     */
    public final TableField<Record, ULong> MAX_TIMER_UPDATE = createField(DSL.name("MAX_TIMER_UPDATE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.COUNT_DELETE</code>.
     */
    public final TableField<Record, ULong> COUNT_DELETE = createField(DSL.name("COUNT_DELETE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.SUM_TIMER_DELETE</code>.
     */
    public final TableField<Record, ULong> SUM_TIMER_DELETE = createField(DSL.name("SUM_TIMER_DELETE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MIN_TIMER_DELETE</code>.
     */
    public final TableField<Record, ULong> MIN_TIMER_DELETE = createField(DSL.name("MIN_TIMER_DELETE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.AVG_TIMER_DELETE</code>.
     */
    public final TableField<Record, ULong> AVG_TIMER_DELETE = createField(DSL.name("AVG_TIMER_DELETE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MAX_TIMER_DELETE</code>.
     */
    public final TableField<Record, ULong> MAX_TIMER_DELETE = createField(DSL.name("MAX_TIMER_DELETE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    private TableIoWaitsSummaryByIndexUsage(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private TableIoWaitsSummaryByIndexUsage(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> TableIoWaitsSummaryByIndexUsage(Table<O> child, ForeignKey<O, Record> key) {
