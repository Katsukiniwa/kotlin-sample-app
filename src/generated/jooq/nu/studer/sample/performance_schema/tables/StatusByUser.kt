...
open class StatusByUser(
    ...
    companion object {
         ...
         */
        val STATUS_BY_USER = StatusByUser()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, STATUS_BY_USER, null)
