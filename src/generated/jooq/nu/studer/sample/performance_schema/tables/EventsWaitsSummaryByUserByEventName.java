...
public class EventsWaitsSummaryByUserByEventName extends TableImpl<Record> {
    ...
    private EventsWaitsSummaryByUserByEventName(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsWaitsSummaryByUserByEventName(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsWaitsSummaryByUserByEventName(Table<O> child, ForeignKey<O, Record> key) {
