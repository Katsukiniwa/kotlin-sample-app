...
open class TableIoWaitsSummaryByIndexUsage(
    ...
    companion object {
         ...
         */
        val TABLE_IO_WAITS_SUMMARY_BY_INDEX_USAGE = TableIoWaitsSummaryByIndexUsage()
    }
     ...
     */
    val COUNT_FETCH: TableField<Record, ULong?> = createField(DSL.name("COUNT_FETCH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.SUM_TIMER_FETCH</code>.
     */
    val SUM_TIMER_FETCH: TableField<Record, ULong?> = createField(DSL.name("SUM_TIMER_FETCH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MIN_TIMER_FETCH</code>.
     */
    val MIN_TIMER_FETCH: TableField<Record, ULong?> = createField(DSL.name("MIN_TIMER_FETCH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.AVG_TIMER_FETCH</code>.
     */
    val AVG_TIMER_FETCH: TableField<Record, ULong?> = createField(DSL.name("AVG_TIMER_FETCH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MAX_TIMER_FETCH</code>.
     */
    val MAX_TIMER_FETCH: TableField<Record, ULong?> = createField(DSL.name("MAX_TIMER_FETCH"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.COUNT_INSERT</code>.
     */
    val COUNT_INSERT: TableField<Record, ULong?> = createField(DSL.name("COUNT_INSERT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.SUM_TIMER_INSERT</code>.
     */
    val SUM_TIMER_INSERT: TableField<Record, ULong?> = createField(DSL.name("SUM_TIMER_INSERT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MIN_TIMER_INSERT</code>.
     */
    val MIN_TIMER_INSERT: TableField<Record, ULong?> = createField(DSL.name("MIN_TIMER_INSERT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.AVG_TIMER_INSERT</code>.
     */
    val AVG_TIMER_INSERT: TableField<Record, ULong?> = createField(DSL.name("AVG_TIMER_INSERT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MAX_TIMER_INSERT</code>.
     */
    val MAX_TIMER_INSERT: TableField<Record, ULong?> = createField(DSL.name("MAX_TIMER_INSERT"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.COUNT_UPDATE</code>.
     */
    val COUNT_UPDATE: TableField<Record, ULong?> = createField(DSL.name("COUNT_UPDATE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.SUM_TIMER_UPDATE</code>.
     */
    val SUM_TIMER_UPDATE: TableField<Record, ULong?> = createField(DSL.name("SUM_TIMER_UPDATE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MIN_TIMER_UPDATE</code>.
     */
    val MIN_TIMER_UPDATE: TableField<Record, ULong?> = createField(DSL.name("MIN_TIMER_UPDATE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.AVG_TIMER_UPDATE</code>.
     */
    val AVG_TIMER_UPDATE: TableField<Record, ULong?> = createField(DSL.name("AVG_TIMER_UPDATE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MAX_TIMER_UPDATE</code>.
     */
    val MAX_TIMER_UPDATE: TableField<Record, ULong?> = createField(DSL.name("MAX_TIMER_UPDATE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.COUNT_DELETE</code>.
     */
    val COUNT_DELETE: TableField<Record, ULong?> = createField(DSL.name("COUNT_DELETE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.SUM_TIMER_DELETE</code>.
     */
    val SUM_TIMER_DELETE: TableField<Record, ULong?> = createField(DSL.name("SUM_TIMER_DELETE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MIN_TIMER_DELETE</code>.
     */
    val MIN_TIMER_DELETE: TableField<Record, ULong?> = createField(DSL.name("MIN_TIMER_DELETE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.AVG_TIMER_DELETE</code>.
     */
    val AVG_TIMER_DELETE: TableField<Record, ULong?> = createField(DSL.name("AVG_TIMER_DELETE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")

    /**
     * The column <code>performance_schema.table_io_waits_summary_by_index_usage.MAX_TIMER_DELETE</code>.
     */
    val MAX_TIMER_DELETE: TableField<Record, ULong?> = createField(DSL.name("MAX_TIMER_DELETE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, TABLE_IO_WAITS_SUMMARY_BY_INDEX_USAGE, null)
