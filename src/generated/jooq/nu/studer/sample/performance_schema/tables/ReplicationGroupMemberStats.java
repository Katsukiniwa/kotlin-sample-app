...
public class ReplicationGroupMemberStats extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> VIEW_ID = createField(DSL.name("VIEW_ID"), SQLDataType.CHAR(60).nullable(false), this, "");
     ...
     */
    public final TableField<Record, ULong> COUNT_TRANSACTIONS_IN_QUEUE = createField(DSL.name("COUNT_TRANSACTIONS_IN_QUEUE"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.replication_group_member_stats.COUNT_TRANSACTIONS_CHECKED</code>.
     */
    public final TableField<Record, ULong> COUNT_TRANSACTIONS_CHECKED = createField(DSL.name("COUNT_TRANSACTIONS_CHECKED"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.replication_group_member_stats.COUNT_CONFLICTS_DETECTED</code>.
     */
    public final TableField<Record, ULong> COUNT_CONFLICTS_DETECTED = createField(DSL.name("COUNT_CONFLICTS_DETECTED"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.replication_group_member_stats.COUNT_TRANSACTIONS_ROWS_VALIDATING</code>.
     */
    public final TableField<Record, ULong> COUNT_TRANSACTIONS_ROWS_VALIDATING = createField(DSL.name("COUNT_TRANSACTIONS_ROWS_VALIDATING"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>performance_schema.replication_group_member_stats.TRANSACTIONS_COMMITTED_ALL_MEMBERS</code>.
     */
    public final TableField<Record, String> TRANSACTIONS_COMMITTED_ALL_MEMBERS = createField(DSL.name("TRANSACTIONS_COMMITTED_ALL_MEMBERS"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>performance_schema.replication_group_member_stats.LAST_CONFLICT_FREE_TRANSACTION</code>.
     */
    public final TableField<Record, String> LAST_CONFLICT_FREE_TRANSACTION = createField(DSL.name("LAST_CONFLICT_FREE_TRANSACTION"), SQLDataType.CLOB.nullable(false), this, "");

    private ReplicationGroupMemberStats(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private ReplicationGroupMemberStats(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> ReplicationGroupMemberStats(Table<O> child, ForeignKey<O, Record> key) {
