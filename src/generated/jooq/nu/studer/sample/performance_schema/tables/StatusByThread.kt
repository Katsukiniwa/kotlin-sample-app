...
open class StatusByThread(
    ...
    companion object {
         ...
         */
        val STATUS_BY_THREAD = StatusByThread()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, STATUS_BY_THREAD, null)
