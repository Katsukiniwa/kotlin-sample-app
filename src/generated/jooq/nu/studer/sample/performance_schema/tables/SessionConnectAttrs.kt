...
open class SessionConnectAttrs(
    ...
    companion object {
         ...
         */
        val SESSION_CONNECT_ATTRS = SessionConnectAttrs()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, SESSION_CONNECT_ATTRS, null)
