...
public class EventsStatementsSummaryByHostByEventName extends TableImpl<Record> {
    ...
    private EventsStatementsSummaryByHostByEventName(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsStatementsSummaryByHostByEventName(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsStatementsSummaryByHostByEventName(Table<O> child, ForeignKey<O, Record> key) {
