...
open class FileSummaryByInstance(
    ...
    companion object {
         ...
         */
        val FILE_SUMMARY_BY_INSTANCE = FileSummaryByInstance()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, FILE_SUMMARY_BY_INSTANCE, null)
