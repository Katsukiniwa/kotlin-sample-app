...
open class TableIoWaitsSummaryByTable(
    ...
    companion object {
         ...
         */
        val TABLE_IO_WAITS_SUMMARY_BY_TABLE = TableIoWaitsSummaryByTable()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, TABLE_IO_WAITS_SUMMARY_BY_TABLE, null)
