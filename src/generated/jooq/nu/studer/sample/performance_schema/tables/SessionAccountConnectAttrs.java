...
public class SessionAccountConnectAttrs extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> PROCESSLIST_ID = createField(DSL.name("PROCESSLIST_ID"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    private SessionAccountConnectAttrs(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private SessionAccountConnectAttrs(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> SessionAccountConnectAttrs(Table<O> child, ForeignKey<O, Record> key) {
