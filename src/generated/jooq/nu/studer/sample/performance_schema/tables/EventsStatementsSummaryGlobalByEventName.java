...
public class EventsStatementsSummaryGlobalByEventName extends TableImpl<Record> {
    ...
    private EventsStatementsSummaryGlobalByEventName(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private EventsStatementsSummaryGlobalByEventName(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> EventsStatementsSummaryGlobalByEventName(Table<O> child, ForeignKey<O, Record> key) {
