...
open class EventsStagesSummaryByUserByEventName(
    ...
    companion object {
         ...
         */
        val EVENTS_STAGES_SUMMARY_BY_USER_BY_EVENT_NAME = EventsStagesSummaryByUserByEventName()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, EVENTS_STAGES_SUMMARY_BY_USER_BY_EVENT_NAME, null)
