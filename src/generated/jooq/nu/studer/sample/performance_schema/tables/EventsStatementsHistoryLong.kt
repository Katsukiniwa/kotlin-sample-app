...
open class EventsStatementsHistoryLong(
    ...
    companion object {
         ...
         */
        val EVENTS_STATEMENTS_HISTORY_LONG = EventsStatementsHistoryLong()
    }
     ...
     */
    val NESTING_EVENT_TYPE: TableField<Record, EventsStatementsHistoryLongNestingEventType?> = createField(DSL.name("NESTING_EVENT_TYPE"), SQLDataType.VARCHAR(11).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsStatementsHistoryLongNestingEventType::class.java), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, EVENTS_STATEMENTS_HISTORY_LONG, null)
