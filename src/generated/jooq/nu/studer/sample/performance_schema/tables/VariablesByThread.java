...
public class VariablesByThread extends TableImpl<Record> {
    ...
    private VariablesByThread(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private VariablesByThread(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> VariablesByThread(Table<O> child, ForeignKey<O, Record> key) {
