...
open class EventsWaitsSummaryByAccountByEventName(
    alias: Name,
    ...
    companion object {
         ...
         */
        val EVENTS_WAITS_SUMMARY_BY_ACCOUNT_BY_EVENT_NAME = EventsWaitsSummaryByAccountByEventName()
    }
     ...
     */
    constructor(): this(DSL.name("events_waits_summary_by_account_by_event_name"), null)

    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, EVENTS_WAITS_SUMMARY_BY_ACCOUNT_BY_EVENT_NAME, null)
    override fun getSchema(): Schema = PerformanceSchema.PERFORMANCE_SCHEMA
    override fun `as`(alias: String): EventsWaitsSummaryByAccountByEventName = EventsWaitsSummaryByAccountByEventName(DSL.name(alias), this)
    override fun `as`(alias: Name): EventsWaitsSummaryByAccountByEventName = EventsWaitsSummaryByAccountByEventName(alias, this)

    /**
     * Rename this table
     */
    override fun rename(name: String): EventsWaitsSummaryByAccountByEventName = EventsWaitsSummaryByAccountByEventName(DSL.name(name), null)

    /**
     * Rename this table
     */
    override fun rename(name: Name): EventsWaitsSummaryByAccountByEventName = EventsWaitsSummaryByAccountByEventName(name, null)
}
