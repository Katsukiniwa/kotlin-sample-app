...
open class EventsStagesHistory(
    ...
    companion object {
         ...
         */
        val EVENTS_STAGES_HISTORY = EventsStagesHistory()
    }
     ...
     */
    val NESTING_EVENT_TYPE: TableField<Record, EventsStagesHistoryNestingEventType?> = createField(DSL.name("NESTING_EVENT_TYPE"), SQLDataType.VARCHAR(11).asEnumDataType(nu.studer.sample.performance_schema.enums.EventsStagesHistoryNestingEventType::class.java), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, EVENTS_STAGES_HISTORY, null)
