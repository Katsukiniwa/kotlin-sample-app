...
public class SocketSummaryByEventName extends TableImpl<Record> {
    ...
    private SocketSummaryByEventName(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private SocketSummaryByEventName(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> SocketSummaryByEventName(Table<O> child, ForeignKey<O, Record> key) {
