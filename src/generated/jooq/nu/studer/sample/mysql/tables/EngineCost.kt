...
import nu.studer.sample.mysql.keys.KEY_ENGINE_COST_PRIMARY
...
open class EngineCost(
     ...
     */
    val ENGINE_NAME: TableField<Record, String?> = createField(DSL.name("engine_name"), SQLDataType.VARCHAR(64).nullable(false), this, "")

    /**
     * The column <code>mysql.engine_cost.device_type</code>.
     */
    val DEVICE_TYPE: TableField<Record, Int?> = createField(DSL.name("device_type"), SQLDataType.INTEGER.nullable(false), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, ENGINE_COST, null)
    override fun getSchema(): Schema = Mysql.MYSQL
    override fun getPrimaryKey(): UniqueKey<Record> = KEY_ENGINE_COST_PRIMARY
    override fun getKeys(): List<UniqueKey<Record>> = listOf(KEY_ENGINE_COST_PRIMARY)
