...
public class SlaveMasterInfo extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> HOST = createField(DSL.name("Host"), SQLDataType.CHAR(64), this, "The host name of the master.");
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_SLAVE_MASTER_INFO_PRIMARY);
    }
