...
open class `X$userSummaryByStatementLatency`(
    ...
    companion object {
         ...
         */
        val `X$USER_SUMMARY_BY_STATEMENT_LATENCY` = `X$userSummaryByStatementLatency`()
    }
     ...
     */
    val MAX_LATENCY: TableField<Record, BigInteger?> = createField(DSL.name("max_latency"), SQLDataType.DECIMAL_INTEGER(42), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, `X$USER_SUMMARY_BY_STATEMENT_LATENCY`, null)
