...
public class SchemaTableStatisticsWithBuffer extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> FETCH_LATENCY = createField(DSL.name("fetch_latency"), SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<Record, String> INSERT_LATENCY = createField(DSL.name("insert_latency"), SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<Record, String> UPDATE_LATENCY = createField(DSL.name("update_latency"), SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<Record, String> DELETE_LATENCY = createField(DSL.name("delete_latency"), SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<Record, String> IO_READ = createField(DSL.name("io_read"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>sys.schema_table_statistics_with_buffer.io_read_latency</code>.
     */
    public final TableField<Record, String> IO_READ_LATENCY = createField(DSL.name("io_read_latency"), SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<Record, String> IO_WRITE = createField(DSL.name("io_write"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>sys.schema_table_statistics_with_buffer.io_write_latency</code>.
     */
    public final TableField<Record, String> IO_WRITE_LATENCY = createField(DSL.name("io_write_latency"), SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<Record, String> IO_MISC_LATENCY = createField(DSL.name("io_misc_latency"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>sys.schema_table_statistics_with_buffer.innodb_buffer_allocated</code>.
     */
    public final TableField<Record, String> INNODB_BUFFER_ALLOCATED = createField(DSL.name("innodb_buffer_allocated"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>sys.schema_table_statistics_with_buffer.innodb_buffer_data</code>.
     */
    public final TableField<Record, String> INNODB_BUFFER_DATA = createField(DSL.name("innodb_buffer_data"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>sys.schema_table_statistics_with_buffer.innodb_buffer_free</code>.
     */
    public final TableField<Record, String> INNODB_BUFFER_FREE = createField(DSL.name("innodb_buffer_free"), SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<Record, BigInteger> INNODB_BUFFER_ROWS_CACHED = createField(DSL.name("innodb_buffer_rows_cached"), SQLDataType.DECIMAL_INTEGER(44).defaultValue(DSL.inline("0", SQLDataType.DECIMAL_INTEGER)), this, "");

    private SchemaTableStatisticsWithBuffer(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private SchemaTableStatisticsWithBuffer(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> SchemaTableStatisticsWithBuffer(Table<O> child, ForeignKey<O, Record> key) {
