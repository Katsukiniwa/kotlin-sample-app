...
public class X$waitsGlobalByLatency extends TableImpl<Record> {
    ...
    private X$waitsGlobalByLatency(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$waitsGlobalByLatency(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$waitsGlobalByLatency(Table<O> child, ForeignKey<O, Record> key) {
