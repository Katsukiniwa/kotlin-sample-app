...
open class `X$innodbBufferStatsByTable`(
    ...
    companion object {
         ...
         */
        val `X$INNODB_BUFFER_STATS_BY_TABLE` = `X$innodbBufferStatsByTable`()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, `X$INNODB_BUFFER_STATS_BY_TABLE`, null)
