...
public class X$statementsWithErrorsOrWarnings extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, BigDecimal> ERROR_PCT = createField(DSL.name("error_pct"), SQLDataType.DECIMAL(27, 4).nullable(false).defaultValue(DSL.inline("0.0000", SQLDataType.DECIMAL)), this, "");
     ...
     */
    public final TableField<Record, BigDecimal> WARNING_PCT = createField(DSL.name("warning_pct"), SQLDataType.DECIMAL(27, 4).nullable(false).defaultValue(DSL.inline("0.0000", SQLDataType.DECIMAL)), this, "");
    ...
    private X$statementsWithErrorsOrWarnings(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$statementsWithErrorsOrWarnings(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$statementsWithErrorsOrWarnings(Table<O> child, ForeignKey<O, Record> key) {
