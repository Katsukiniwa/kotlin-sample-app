...
public class X$ioGlobalByWaitByLatency extends TableImpl<Record> {
    ...
    private X$ioGlobalByWaitByLatency(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$ioGlobalByWaitByLatency(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$ioGlobalByWaitByLatency(Table<O> child, ForeignKey<O, Record> key) {
