...
public class X$userSummaryByFileIoType extends TableImpl<Record> {
    ...
    private X$userSummaryByFileIoType(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$userSummaryByFileIoType(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$userSummaryByFileIoType(Table<O> child, ForeignKey<O, Record> key) {
