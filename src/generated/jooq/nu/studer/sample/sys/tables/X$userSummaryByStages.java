...
public class X$userSummaryByStages extends TableImpl<Record> {
    ...
    private X$userSummaryByStages(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$userSummaryByStages(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$userSummaryByStages(Table<O> child, ForeignKey<O, Record> key) {
