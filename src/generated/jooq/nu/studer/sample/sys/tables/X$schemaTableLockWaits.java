...
public class X$schemaTableLockWaits extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, ULong> WAITING_THREAD_ID = createField(DSL.name("waiting_thread_id"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.waiting_pid</code>.
     */
    public final TableField<Record, ULong> WAITING_PID = createField(DSL.name("waiting_pid"), SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.waiting_account</code>.
     */
    public final TableField<Record, String> WAITING_ACCOUNT = createField(DSL.name("waiting_account"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.waiting_lock_type</code>.
     */
    public final TableField<Record, String> WAITING_LOCK_TYPE = createField(DSL.name("waiting_lock_type"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.waiting_lock_duration</code>.
     */
    public final TableField<Record, String> WAITING_LOCK_DURATION = createField(DSL.name("waiting_lock_duration"), SQLDataType.VARCHAR(32).nullable(false), this, "");
     ...
     */
    public final TableField<Record, Long> WAITING_QUERY_SECS = createField(DSL.name("waiting_query_secs"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.waiting_query_rows_affected</code>.
     */
    public final TableField<Record, ULong> WAITING_QUERY_ROWS_AFFECTED = createField(DSL.name("waiting_query_rows_affected"), SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.waiting_query_rows_examined</code>.
     */
    public final TableField<Record, ULong> WAITING_QUERY_ROWS_EXAMINED = createField(DSL.name("waiting_query_rows_examined"), SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.blocking_thread_id</code>.
     */
    public final TableField<Record, ULong> BLOCKING_THREAD_ID = createField(DSL.name("blocking_thread_id"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.blocking_pid</code>.
     */
    public final TableField<Record, ULong> BLOCKING_PID = createField(DSL.name("blocking_pid"), SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.blocking_account</code>.
     */
    public final TableField<Record, String> BLOCKING_ACCOUNT = createField(DSL.name("blocking_account"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.blocking_lock_type</code>.
     */
    public final TableField<Record, String> BLOCKING_LOCK_TYPE = createField(DSL.name("blocking_lock_type"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.blocking_lock_duration</code>.
     */
    public final TableField<Record, String> BLOCKING_LOCK_DURATION = createField(DSL.name("blocking_lock_duration"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.sql_kill_blocking_query</code>.
     */
    public final TableField<Record, String> SQL_KILL_BLOCKING_QUERY = createField(DSL.name("sql_kill_blocking_query"), SQLDataType.VARCHAR(31), this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.sql_kill_blocking_connection</code>.
     */
    public final TableField<Record, String> SQL_KILL_BLOCKING_CONNECTION = createField(DSL.name("sql_kill_blocking_connection"), SQLDataType.VARCHAR(25), this, "");

    private X$schemaTableLockWaits(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$schemaTableLockWaits(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$schemaTableLockWaits(Table<O> child, ForeignKey<O, Record> key) {
