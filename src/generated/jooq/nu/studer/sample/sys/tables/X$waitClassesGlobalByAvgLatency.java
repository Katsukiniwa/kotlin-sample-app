...
public class X$waitClassesGlobalByAvgLatency extends TableImpl<Record> {
    ...
    private X$waitClassesGlobalByAvgLatency(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$waitClassesGlobalByAvgLatency(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$waitClassesGlobalByAvgLatency(Table<O> child, ForeignKey<O, Record> key) {
