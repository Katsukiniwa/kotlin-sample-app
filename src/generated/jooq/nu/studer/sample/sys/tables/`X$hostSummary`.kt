...
open class `X$hostSummary`(
    ...
    companion object {
         ...
         */
        val `X$HOST_SUMMARY` = `X$hostSummary`()
    }
     ...
     */
    val STATEMENT_AVG_LATENCY: TableField<Record, BigDecimal?> = createField(DSL.name("statement_avg_latency"), SQLDataType.DECIMAL(65, 4), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, `X$HOST_SUMMARY`, null)
