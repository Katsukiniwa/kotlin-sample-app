...
open class MemoryByUserByCurrentBytes(
    ...
    companion object {
         ...
         */
        val MEMORY_BY_USER_BY_CURRENT_BYTES = MemoryByUserByCurrentBytes()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, MEMORY_BY_USER_BY_CURRENT_BYTES, null)
