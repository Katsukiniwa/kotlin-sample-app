...
public class MemoryByUserByCurrentBytes extends TableImpl<Record> {
    ...
    private MemoryByUserByCurrentBytes(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private MemoryByUserByCurrentBytes(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> MemoryByUserByCurrentBytes(Table<O> child, ForeignKey<O, Record> key) {
