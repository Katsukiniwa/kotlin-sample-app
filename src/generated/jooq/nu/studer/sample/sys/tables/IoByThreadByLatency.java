...
public class IoByThreadByLatency extends TableImpl<Record> {
    ...
    private IoByThreadByLatency(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private IoByThreadByLatency(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> IoByThreadByLatency(Table<O> child, ForeignKey<O, Record> key) {
