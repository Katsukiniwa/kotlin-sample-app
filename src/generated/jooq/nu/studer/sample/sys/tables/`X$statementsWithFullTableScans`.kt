...
open class `X$statementsWithFullTableScans`(
    ...
    companion object {
         ...
         */
        val `X$STATEMENTS_WITH_FULL_TABLE_SCANS` = `X$statementsWithFullTableScans`()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, `X$STATEMENTS_WITH_FULL_TABLE_SCANS`, null)
