...
public class SysConfig extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, LocalDateTime> SET_TIME = createField(DSL.name("set_time"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_SYS_CONFIG_PRIMARY);
    }
