...
open class `X$hostSummaryByFileIoType`(
    ...
    companion object {
         ...
         */
        val `X$HOST_SUMMARY_BY_FILE_IO_TYPE` = `X$hostSummaryByFileIoType`()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, `X$HOST_SUMMARY_BY_FILE_IO_TYPE`, null)
