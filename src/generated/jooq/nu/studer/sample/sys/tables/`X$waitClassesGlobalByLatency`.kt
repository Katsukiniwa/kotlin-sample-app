...
open class `X$waitClassesGlobalByLatency`(
    ...
    companion object {
         ...
         */
        val `X$WAIT_CLASSES_GLOBAL_BY_LATENCY` = `X$waitClassesGlobalByLatency`()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, `X$WAIT_CLASSES_GLOBAL_BY_LATENCY`, null)
