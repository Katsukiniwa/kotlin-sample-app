...
open class WaitsByUserByLatency(
    ...
    companion object {
         ...
         */
        val WAITS_BY_USER_BY_LATENCY = WaitsByUserByLatency()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, WAITS_BY_USER_BY_LATENCY, null)
