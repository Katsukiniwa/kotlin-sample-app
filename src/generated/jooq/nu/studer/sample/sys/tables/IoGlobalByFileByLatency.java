...
public class IoGlobalByFileByLatency extends TableImpl<Record> {
    ...
    private IoGlobalByFileByLatency(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private IoGlobalByFileByLatency(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> IoGlobalByFileByLatency(Table<O> child, ForeignKey<O, Record> key) {
