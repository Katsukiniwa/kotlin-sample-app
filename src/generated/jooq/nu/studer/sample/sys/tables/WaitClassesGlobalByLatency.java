...
public class WaitClassesGlobalByLatency extends TableImpl<Record> {
    ...
    private WaitClassesGlobalByLatency(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private WaitClassesGlobalByLatency(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> WaitClassesGlobalByLatency(Table<O> child, ForeignKey<O, Record> key) {
