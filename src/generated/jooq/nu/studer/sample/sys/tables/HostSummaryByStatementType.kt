...
open class HostSummaryByStatementType(
    ...
    companion object {
         ...
         */
        val HOST_SUMMARY_BY_STATEMENT_TYPE = HostSummaryByStatementType()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, HOST_SUMMARY_BY_STATEMENT_TYPE, null)
