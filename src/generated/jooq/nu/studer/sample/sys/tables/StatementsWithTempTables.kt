...
open class StatementsWithTempTables(
    alias: Name,
    ...
    companion object {
         ...
         */
        val STATEMENTS_WITH_TEMP_TABLES = StatementsWithTempTables()
    }
     ...
     */
    constructor(): this(DSL.name("statements_with_temp_tables"), null)

    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, STATEMENTS_WITH_TEMP_TABLES, null)
    override fun getSchema(): Schema = Sys.SYS
    override fun `as`(alias: String): StatementsWithTempTables = StatementsWithTempTables(DSL.name(alias), this)
    override fun `as`(alias: Name): StatementsWithTempTables = StatementsWithTempTables(alias, this)

    /**
     * Rename this table
     */
    override fun rename(name: String): StatementsWithTempTables = StatementsWithTempTables(DSL.name(name), null)

    /**
     * Rename this table
     */
    override fun rename(name: Name): StatementsWithTempTables = StatementsWithTempTables(name, null)
}
