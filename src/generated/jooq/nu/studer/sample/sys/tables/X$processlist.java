...
import nu.studer.sample.sys.enums.X$processlistTrxAutocommit;
import nu.studer.sample.sys.enums.X$processlistTrxState;
...
public class X$processlist extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, ULong> STATEMENT_LATENCY = createField(DSL.name("statement_latency"), SQLDataType.BIGINTUNSIGNED, this, "");
     ...
     */
    public final TableField<Record, ULong> LOCK_LATENCY = createField(DSL.name("lock_latency"), SQLDataType.BIGINTUNSIGNED, this, "");
     ...
     */
    public final TableField<Record, ULong> LAST_STATEMENT_LATENCY = createField(DSL.name("last_statement_latency"), SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>sys.x$processlist.current_memory</code>.
     */
    public final TableField<Record, BigInteger> CURRENT_MEMORY = createField(DSL.name("current_memory"), SQLDataType.DECIMAL_INTEGER(41), this, "");
     ...
     */
    public final TableField<Record, String> LAST_WAIT_LATENCY = createField(DSL.name("last_wait_latency"), SQLDataType.VARCHAR(20), this, "");
     ...
     */
    public final TableField<Record, ULong> TRX_LATENCY = createField(DSL.name("trx_latency"), SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>sys.x$processlist.trx_state</code>.
     */
    public final TableField<Record, X$processlistTrxState> TRX_STATE = createField(DSL.name("trx_state"), SQLDataType.VARCHAR(11).asEnumDataType(nu.studer.sample.sys.enums.X$processlistTrxState.class), this, "");

    /**
     * The column <code>sys.x$processlist.trx_autocommit</code>.
     */
    public final TableField<Record, X$processlistTrxAutocommit> TRX_AUTOCOMMIT = createField(DSL.name("trx_autocommit"), SQLDataType.VARCHAR(3).asEnumDataType(nu.studer.sample.sys.enums.X$processlistTrxAutocommit.class), this, "");
    ...
    private X$processlist(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$processlist(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$processlist(Table<O> child, ForeignKey<O, Record> key) {
