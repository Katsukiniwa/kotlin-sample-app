...
public class SchemaTableStatistics extends TableImpl<Record> {
    ...
    private SchemaTableStatistics(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private SchemaTableStatistics(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> SchemaTableStatistics(Table<O> child, ForeignKey<O, Record> key) {
