...
public class X$statementsWithFullTableScans extends TableImpl<Record> {
    ...
    private X$statementsWithFullTableScans(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$statementsWithFullTableScans(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$statementsWithFullTableScans(Table<O> child, ForeignKey<O, Record> key) {
