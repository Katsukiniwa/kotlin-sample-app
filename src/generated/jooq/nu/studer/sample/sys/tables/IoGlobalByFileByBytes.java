...
public class IoGlobalByFileByBytes extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> AVG_WRITE = createField(DSL.name("avg_write"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>sys.io_global_by_file_by_bytes.total</code>.
     */
    public final TableField<Record, String> TOTAL = createField(DSL.name("total"), SQLDataType.CLOB, this, "");
    ...
    private IoGlobalByFileByBytes(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private IoGlobalByFileByBytes(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> IoGlobalByFileByBytes(Table<O> child, ForeignKey<O, Record> key) {
