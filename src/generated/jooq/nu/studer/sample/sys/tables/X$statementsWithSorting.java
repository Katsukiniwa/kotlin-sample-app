...
public class X$statementsWithSorting extends TableImpl<Record> {
    ...
    private X$statementsWithSorting(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$statementsWithSorting(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$statementsWithSorting(Table<O> child, ForeignKey<O, Record> key) {
