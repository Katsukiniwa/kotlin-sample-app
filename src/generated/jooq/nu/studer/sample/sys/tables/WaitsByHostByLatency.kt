...
open class WaitsByHostByLatency(
    ...
    companion object {
         ...
         */
        val WAITS_BY_HOST_BY_LATENCY = WaitsByHostByLatency()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, WAITS_BY_HOST_BY_LATENCY, null)
