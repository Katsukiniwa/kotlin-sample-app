...
public class X$memoryByUserByCurrentBytes extends TableImpl<Record> {
    ...
    private X$memoryByUserByCurrentBytes(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$memoryByUserByCurrentBytes(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$memoryByUserByCurrentBytes(Table<O> child, ForeignKey<O, Record> key) {
