...
public class Metrics extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> VARIABLE_NAME = createField(DSL.name("Variable_name"), SQLDataType.VARCHAR(193), this, "");
     ...
     */
    public final TableField<Record, String> TYPE = createField(DSL.name("Type"), SQLDataType.VARCHAR(210), this, "");
