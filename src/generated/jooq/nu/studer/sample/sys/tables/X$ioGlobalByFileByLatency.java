...
public class X$ioGlobalByFileByLatency extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, ULong> READ_LATENCY = createField(DSL.name("read_latency"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
     ...
     */
    public final TableField<Record, ULong> WRITE_LATENCY = createField(DSL.name("write_latency"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
     ...
     */
    public final TableField<Record, ULong> MISC_LATENCY = createField(DSL.name("misc_latency"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    private X$ioGlobalByFileByLatency(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$ioGlobalByFileByLatency(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$ioGlobalByFileByLatency(Table<O> child, ForeignKey<O, Record> key) {
