...
open class `X$userSummaryByStages`(
    ...
    companion object {
         ...
         */
        val `X$USER_SUMMARY_BY_STAGES` = `X$userSummaryByStages`()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, `X$USER_SUMMARY_BY_STAGES`, null)
