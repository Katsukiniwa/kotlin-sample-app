...
public class LatestFileIo extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> REQUESTED = createField(DSL.name("requested"), SQLDataType.CLOB, this, "");

    private LatestFileIo(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private LatestFileIo(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> LatestFileIo(Table<O> child, ForeignKey<O, Record> key) {
