...
public class StatementsWithErrorsOrWarnings extends TableImpl<Record> {
    ...
    private StatementsWithErrorsOrWarnings(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private StatementsWithErrorsOrWarnings(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> StatementsWithErrorsOrWarnings(Table<O> child, ForeignKey<O, Record> key) {
