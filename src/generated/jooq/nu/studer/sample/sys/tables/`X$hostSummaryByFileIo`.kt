...
open class `X$hostSummaryByFileIo`(
    ...
    companion object {
         ...
         */
        val `X$HOST_SUMMARY_BY_FILE_IO` = `X$hostSummaryByFileIo`()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, `X$HOST_SUMMARY_BY_FILE_IO`, null)
