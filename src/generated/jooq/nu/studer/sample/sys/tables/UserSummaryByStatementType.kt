...
open class UserSummaryByStatementType(
    ...
    companion object {
         ...
         */
        val USER_SUMMARY_BY_STATEMENT_TYPE = UserSummaryByStatementType()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, USER_SUMMARY_BY_STATEMENT_TYPE, null)
