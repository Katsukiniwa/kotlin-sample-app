...
public class X$innodbBufferStatsBySchema extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, BigInteger> ALLOCATED = createField(DSL.name("allocated"), SQLDataType.DECIMAL_INTEGER(43), this, "");

    /**
     * The column <code>sys.x$innodb_buffer_stats_by_schema.data</code>.
     */
    public final TableField<Record, BigInteger> DATA = createField(DSL.name("data"), SQLDataType.DECIMAL_INTEGER(43), this, "");
     ...
     */
    public final TableField<Record, BigInteger> ROWS_CACHED = createField(DSL.name("rows_cached"), SQLDataType.DECIMAL_INTEGER(44).nullable(false).defaultValue(DSL.inline("0", SQLDataType.DECIMAL_INTEGER)), this, "");
