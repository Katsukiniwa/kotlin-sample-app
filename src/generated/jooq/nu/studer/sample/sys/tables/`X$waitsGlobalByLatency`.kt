...
open class `X$waitsGlobalByLatency`(
    ...
    companion object {
         ...
         */
        val `X$WAITS_GLOBAL_BY_LATENCY` = `X$waitsGlobalByLatency`()
    }
     ...
     */
    val EVENTS: TableField<Record, String?> = createField(DSL.name("events"), SQLDataType.VARCHAR(128).nullable(false), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, `X$WAITS_GLOBAL_BY_LATENCY`, null)
