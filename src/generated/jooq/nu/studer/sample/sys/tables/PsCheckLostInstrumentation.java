...
public class PsCheckLostInstrumentation extends TableImpl<Record> {
    ...
    private PsCheckLostInstrumentation(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private PsCheckLostInstrumentation(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PsCheckLostInstrumentation(Table<O> child, ForeignKey<O, Record> key) {
