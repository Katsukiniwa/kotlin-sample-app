...
public class X$statementAnalysis extends TableImpl<Record> {
    ...
    private X$statementAnalysis(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$statementAnalysis(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$statementAnalysis(Table<O> child, ForeignKey<O, Record> key) {
