...
public class HostSummaryByStages extends TableImpl<Record> {
    ...
    private HostSummaryByStages(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private HostSummaryByStages(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> HostSummaryByStages(Table<O> child, ForeignKey<O, Record> key) {
