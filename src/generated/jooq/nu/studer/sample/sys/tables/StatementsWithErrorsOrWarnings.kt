...
open class StatementsWithErrorsOrWarnings(
    ...
    companion object {
         ...
         */
        val STATEMENTS_WITH_ERRORS_OR_WARNINGS = StatementsWithErrorsOrWarnings()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, STATEMENTS_WITH_ERRORS_OR_WARNINGS, null)
