...
public class Processlist extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, ProcesslistTrxState> TRX_STATE = createField(DSL.name("trx_state"), SQLDataType.VARCHAR(11).asEnumDataType(nu.studer.sample.sys.enums.ProcesslistTrxState.class), this, "");

    /**
     * The column <code>sys.processlist.trx_autocommit</code>.
     */
    public final TableField<Record, ProcesslistTrxAutocommit> TRX_AUTOCOMMIT = createField(DSL.name("trx_autocommit"), SQLDataType.VARCHAR(3).asEnumDataType(nu.studer.sample.sys.enums.ProcesslistTrxAutocommit.class), this, "");
