...
public class X$psSchemaTableStatisticsIo extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, BigInteger> COUNT_READ = createField(DSL.name("count_read"), SQLDataType.DECIMAL_INTEGER(42), this, "");

    /**
     * The column <code>sys.x$ps_schema_table_statistics_io.sum_number_of_bytes_read</code>.
     */
    public final TableField<Record, BigInteger> SUM_NUMBER_OF_BYTES_READ = createField(DSL.name("sum_number_of_bytes_read"), SQLDataType.DECIMAL_INTEGER(41), this, "");

    /**
     * The column <code>sys.x$ps_schema_table_statistics_io.sum_timer_read</code>.
     */
    public final TableField<Record, BigInteger> SUM_TIMER_READ = createField(DSL.name("sum_timer_read"), SQLDataType.DECIMAL_INTEGER(42), this, "");

    /**
     * The column <code>sys.x$ps_schema_table_statistics_io.count_write</code>.
     */
    public final TableField<Record, BigInteger> COUNT_WRITE = createField(DSL.name("count_write"), SQLDataType.DECIMAL_INTEGER(42), this, "");

    /**
     * The column <code>sys.x$ps_schema_table_statistics_io.sum_number_of_bytes_write</code>.
     */
    public final TableField<Record, BigInteger> SUM_NUMBER_OF_BYTES_WRITE = createField(DSL.name("sum_number_of_bytes_write"), SQLDataType.DECIMAL_INTEGER(41), this, "");

    /**
     * The column <code>sys.x$ps_schema_table_statistics_io.sum_timer_write</code>.
     */
    public final TableField<Record, BigInteger> SUM_TIMER_WRITE = createField(DSL.name("sum_timer_write"), SQLDataType.DECIMAL_INTEGER(42), this, "");

    /**
     * The column <code>sys.x$ps_schema_table_statistics_io.count_misc</code>.
     */
    public final TableField<Record, BigInteger> COUNT_MISC = createField(DSL.name("count_misc"), SQLDataType.DECIMAL_INTEGER(42), this, "");

    /**
     * The column <code>sys.x$ps_schema_table_statistics_io.sum_timer_misc</code>.
     */
    public final TableField<Record, BigInteger> SUM_TIMER_MISC = createField(DSL.name("sum_timer_misc"), SQLDataType.DECIMAL_INTEGER(42), this, "");

    private X$psSchemaTableStatisticsIo(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$psSchemaTableStatisticsIo(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$psSchemaTableStatisticsIo(Table<O> child, ForeignKey<O, Record> key) {
