...
public class StatementsWithTempTables extends TableImpl<Record> {
    ...
    private StatementsWithTempTables(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private StatementsWithTempTables(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> StatementsWithTempTables(Table<O> child, ForeignKey<O, Record> key) {
