...
open class WaitsGlobalByLatency(
    ...
    companion object {
         ...
         */
        val WAITS_GLOBAL_BY_LATENCY = WaitsGlobalByLatency()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, WAITS_GLOBAL_BY_LATENCY, null)
