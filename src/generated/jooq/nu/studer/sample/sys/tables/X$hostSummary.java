...
public class X$hostSummary extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, BigDecimal> STATEMENT_AVG_LATENCY = createField(DSL.name("statement_avg_latency"), SQLDataType.DECIMAL(65, 4), this, "");
    ...
    private X$hostSummary(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$hostSummary(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$hostSummary(Table<O> child, ForeignKey<O, Record> key) {
