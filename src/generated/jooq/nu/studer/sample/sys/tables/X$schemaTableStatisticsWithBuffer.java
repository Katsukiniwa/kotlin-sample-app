...
public class X$schemaTableStatisticsWithBuffer extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, BigInteger> INNODB_BUFFER_ALLOCATED = createField(DSL.name("innodb_buffer_allocated"), SQLDataType.DECIMAL_INTEGER(43), this, "");

    /**
     * The column <code>sys.x$schema_table_statistics_with_buffer.innodb_buffer_data</code>.
     */
    public final TableField<Record, BigInteger> INNODB_BUFFER_DATA = createField(DSL.name("innodb_buffer_data"), SQLDataType.DECIMAL_INTEGER(43), this, "");

    /**
     * The column <code>sys.x$schema_table_statistics_with_buffer.innodb_buffer_free</code>.
     */
    public final TableField<Record, BigInteger> INNODB_BUFFER_FREE = createField(DSL.name("innodb_buffer_free"), SQLDataType.DECIMAL_INTEGER(44), this, "");
