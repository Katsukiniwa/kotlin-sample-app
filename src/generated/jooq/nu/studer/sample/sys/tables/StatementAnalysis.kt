...
open class StatementAnalysis(
    ...
    companion object {
         ...
         */
        val STATEMENT_ANALYSIS = StatementAnalysis()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, STATEMENT_ANALYSIS, null)
