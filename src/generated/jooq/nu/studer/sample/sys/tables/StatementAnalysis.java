...
public class StatementAnalysis extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, BigInteger> ROWS_AFFECTED_AVG = createField(DSL.name("rows_affected_avg"), SQLDataType.DECIMAL_INTEGER(21).nullable(false).defaultValue(DSL.inline("0", SQLDataType.DECIMAL_INTEGER)), this, "");

    /**
     * The column <code>sys.statement_analysis.tmp_tables</code>.
     */
    public final TableField<Record, ULong> TMP_TABLES = createField(DSL.name("tmp_tables"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>sys.statement_analysis.tmp_disk_tables</code>.
     */
    public final TableField<Record, ULong> TMP_DISK_TABLES = createField(DSL.name("tmp_disk_tables"), SQLDataType.BIGINTUNSIGNED.nullable(false), this, "");
    ...
    private StatementAnalysis(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private StatementAnalysis(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> StatementAnalysis(Table<O> child, ForeignKey<O, Record> key) {
