...
public class X$hostSummaryByStatementType extends TableImpl<Record> {
    ...
    private X$hostSummaryByStatementType(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private X$hostSummaryByStatementType(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> X$hostSummaryByStatementType(Table<O> child, ForeignKey<O, Record> key) {
