...
open class UserSummaryByFileIoType(
    ...
    companion object {
         ...
         */
        val USER_SUMMARY_BY_FILE_IO_TYPE = UserSummaryByFileIoType()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, USER_SUMMARY_BY_FILE_IO_TYPE, null)
