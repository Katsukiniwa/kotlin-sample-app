...
public class HostSummaryByFileIo extends TableImpl<Record> {
    ...
    private HostSummaryByFileIo(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private HostSummaryByFileIo(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> HostSummaryByFileIo(Table<O> child, ForeignKey<O, Record> key) {
