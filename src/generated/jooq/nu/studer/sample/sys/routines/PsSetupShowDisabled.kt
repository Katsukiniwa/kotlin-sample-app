...
open class PsSetupShowDisabled : AbstractRoutine<java.lang.Void>("ps_setup_show_disabled", Sys.SYS) {
    companion object {
     ...
     */
    fun setInShowInstruments(value: Byte?) = setValue(IN_SHOW_INSTRUMENTS, value)

    /**
     * Set the <code>in_show_threads</code> parameter IN value to the routine
     */
    fun setInShowThreads(value: Byte?) = setValue(IN_SHOW_THREADS, value)
}
