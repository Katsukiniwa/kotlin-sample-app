...
open class PsTraceStatementDigest : AbstractRoutine<java.lang.Void>("ps_trace_statement_digest", Sys.SYS) {
    companion object {
         ...
         */
        val IN_DIGEST: Parameter<String?> = Internal.createParameter("in_digest", SQLDataType.VARCHAR(32), false, false)
     ...
     */
    fun setInDigest(value: String?) = setValue(IN_DIGEST, value)

    /**
     * Set the <code>in_runtime</code> parameter IN value to the routine
     */
    fun setInRuntime(value: Int?) = setValue(IN_RUNTIME, value)
     ...
     */
    fun setInAutoEnable(value: Byte?) = setValue(IN_AUTO_ENABLE, value)
}
