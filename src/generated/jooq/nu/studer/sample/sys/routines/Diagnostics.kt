...
open class Diagnostics : AbstractRoutine<java.lang.Void>("diagnostics", Sys.SYS) {
    companion object {

        /**
         * The parameter <code>sys.diagnostics.in_max_runtime</code>.
         */
        val IN_MAX_RUNTIME: Parameter<UInteger?> = Internal.createParameter("in_max_runtime", SQLDataType.INTEGERUNSIGNED, false, false)

        /**
         * The parameter <code>sys.diagnostics.in_interval</code>.
         */
        val IN_INTERVAL: Parameter<UInteger?> = Internal.createParameter("in_interval", SQLDataType.INTEGERUNSIGNED, false, false)

        /**
         * The parameter <code>sys.diagnostics.in_auto_config</code>.
         */
        val IN_AUTO_CONFIG: Parameter<String?> = Internal.createParameter("in_auto_config", SQLDataType.VARCHAR(7), false, false)
    }
     ...
     */
    fun setInMaxRuntime(value: UInteger?) = setValue(IN_MAX_RUNTIME, value)

    /**
     * Set the <code>in_interval</code> parameter IN value to the routine
     */
    fun setInInterval(value: UInteger?) = setValue(IN_INTERVAL, value)

    /**
     * Set the <code>in_auto_config</code> parameter IN value to the routine
     */
    fun setInAutoConfig(value: String?) = setValue(IN_AUTO_CONFIG, value)
}
