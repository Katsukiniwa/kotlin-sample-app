...
import nu.studer.sample.kotlin_sample_app.Indexes;
...
public class FlywaySchemaHistory extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, LocalDateTime> INSTALLED_ON = createField(DSL.name("installed_on"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<UniqueKey<Record>> getKeys() {
        return Arrays.<UniqueKey<Record>>asList(Keys.KEY_FLYWAY_SCHEMA_HISTORY_PRIMARY);
    }
