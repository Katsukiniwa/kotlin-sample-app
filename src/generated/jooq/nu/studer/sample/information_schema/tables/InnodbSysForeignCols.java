...
public class InnodbSysForeignCols extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> FOR_COL_NAME = createField(DSL.name("FOR_COL_NAME"), SQLDataType.VARCHAR(193).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INNODB_SYS_FOREIGN_COLS.REF_COL_NAME</code>.
     */
    public final TableField<Record, String> REF_COL_NAME = createField(DSL.name("REF_COL_NAME"), SQLDataType.VARCHAR(193).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");
    ...
    private InnodbSysForeignCols(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private InnodbSysForeignCols(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> InnodbSysForeignCols(Table<O> child, ForeignKey<O, Record> key) {
