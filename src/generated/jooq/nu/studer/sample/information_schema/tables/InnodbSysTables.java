...
public class InnodbSysTables extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> FLAG = createField(DSL.name("FLAG"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>information_schema.INNODB_SYS_TABLES.N_COLS</code>.
     */
    public final TableField<Record, Integer> N_COLS = createField(DSL.name("N_COLS"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<Record, String> ROW_FORMAT = createField(DSL.name("ROW_FORMAT"), SQLDataType.VARCHAR(12), this, "");
    ...
    private InnodbSysTables(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private InnodbSysTables(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> InnodbSysTables(Table<O> child, ForeignKey<O, Record> key) {
