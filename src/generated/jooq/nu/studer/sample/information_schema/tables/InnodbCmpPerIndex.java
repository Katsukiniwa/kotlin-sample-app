...
public class InnodbCmpPerIndex extends TableImpl<Record> {
    ...
    private InnodbCmpPerIndex(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private InnodbCmpPerIndex(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> InnodbCmpPerIndex(Table<O> child, ForeignKey<O, Record> key) {
