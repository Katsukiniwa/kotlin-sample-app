...
public class InnodbLockWaits extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> REQUESTING_TRX_ID = createField(DSL.name("requesting_trx_id"), SQLDataType.VARCHAR(18).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INNODB_LOCK_WAITS.requested_lock_id</code>.
     */
    public final TableField<Record, String> REQUESTED_LOCK_ID = createField(DSL.name("requested_lock_id"), SQLDataType.VARCHAR(81).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");
