...
open class InnodbBufferPageLru(
    ...
    companion object {
         ...
         */
        val INNODB_BUFFER_PAGE_LRU = InnodbBufferPageLru()
    }
     ...
     */
    val LRU_POSITION: TableField<Record, ULong?> = createField(DSL.name("LRU_POSITION"), SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINTUNSIGNED)), this, "")
     ...
     */
    val COMPRESSED: TableField<Record, String?> = createField(DSL.name("COMPRESSED"), SQLDataType.VARCHAR(3), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, INNODB_BUFFER_PAGE_LRU, null)
