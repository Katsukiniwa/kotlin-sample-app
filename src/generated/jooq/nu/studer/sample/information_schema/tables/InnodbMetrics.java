...
public class InnodbMetrics extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> SUBSYSTEM = createField(DSL.name("SUBSYSTEM"), SQLDataType.VARCHAR(193).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<Record, Long> MAX_COUNT = createField(DSL.name("MAX_COUNT"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.MIN_COUNT</code>.
     */
    public final TableField<Record, Long> MIN_COUNT = createField(DSL.name("MIN_COUNT"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.AVG_COUNT</code>.
     */
    public final TableField<Record, Double> AVG_COUNT = createField(DSL.name("AVG_COUNT"), SQLDataType.DOUBLE, this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.COUNT_RESET</code>.
     */
    public final TableField<Record, Long> COUNT_RESET = createField(DSL.name("COUNT_RESET"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.MAX_COUNT_RESET</code>.
     */
    public final TableField<Record, Long> MAX_COUNT_RESET = createField(DSL.name("MAX_COUNT_RESET"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.MIN_COUNT_RESET</code>.
     */
    public final TableField<Record, Long> MIN_COUNT_RESET = createField(DSL.name("MIN_COUNT_RESET"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.AVG_COUNT_RESET</code>.
     */
    public final TableField<Record, Double> AVG_COUNT_RESET = createField(DSL.name("AVG_COUNT_RESET"), SQLDataType.DOUBLE, this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.TIME_ENABLED</code>.
     */
    public final TableField<Record, LocalDateTime> TIME_ENABLED = createField(DSL.name("TIME_ENABLED"), SQLDataType.LOCALDATETIME(0), this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.TIME_DISABLED</code>.
     */
    public final TableField<Record, LocalDateTime> TIME_DISABLED = createField(DSL.name("TIME_DISABLED"), SQLDataType.LOCALDATETIME(0), this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.TIME_ELAPSED</code>.
     */
    public final TableField<Record, Long> TIME_ELAPSED = createField(DSL.name("TIME_ELAPSED"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.TIME_RESET</code>.
     */
    public final TableField<Record, LocalDateTime> TIME_RESET = createField(DSL.name("TIME_RESET"), SQLDataType.LOCALDATETIME(0), this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.STATUS</code>.
     */
    public final TableField<Record, String> STATUS = createField(DSL.name("STATUS"), SQLDataType.VARCHAR(193).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.TYPE</code>.
     */
    public final TableField<Record, String> TYPE = createField(DSL.name("TYPE"), SQLDataType.VARCHAR(193).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.INNODB_METRICS.COMMENT</code>.
     */
    public final TableField<Record, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.VARCHAR(193).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");
