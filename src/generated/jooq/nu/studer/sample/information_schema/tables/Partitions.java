...
public class Partitions extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, ULong> PARTITION_ORDINAL_POSITION = createField(DSL.name("PARTITION_ORDINAL_POSITION"), SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.SUBPARTITION_ORDINAL_POSITION</code>.
     */
    public final TableField<Record, ULong> SUBPARTITION_ORDINAL_POSITION = createField(DSL.name("SUBPARTITION_ORDINAL_POSITION"), SQLDataType.BIGINTUNSIGNED, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.PARTITION_METHOD</code>.
     */
    public final TableField<Record, String> PARTITION_METHOD = createField(DSL.name("PARTITION_METHOD"), SQLDataType.VARCHAR(18), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.SUBPARTITION_METHOD</code>.
     */
    public final TableField<Record, String> SUBPARTITION_METHOD = createField(DSL.name("SUBPARTITION_METHOD"), SQLDataType.VARCHAR(12), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.PARTITION_EXPRESSION</code>.
     */
    public final TableField<Record, String> PARTITION_EXPRESSION = createField(DSL.name("PARTITION_EXPRESSION"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.SUBPARTITION_EXPRESSION</code>.
     */
    public final TableField<Record, String> SUBPARTITION_EXPRESSION = createField(DSL.name("SUBPARTITION_EXPRESSION"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.PARTITION_DESCRIPTION</code>.
     */
    public final TableField<Record, String> PARTITION_DESCRIPTION = createField(DSL.name("PARTITION_DESCRIPTION"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>information_schema.PARTITIONS.TABLE_ROWS</code>.
     */
    public final TableField<Record, ULong> TABLE_ROWS = createField(DSL.name("TABLE_ROWS"), SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINTUNSIGNED)), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.AVG_ROW_LENGTH</code>.
     */
    public final TableField<Record, ULong> AVG_ROW_LENGTH = createField(DSL.name("AVG_ROW_LENGTH"), SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINTUNSIGNED)), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.DATA_LENGTH</code>.
     */
    public final TableField<Record, ULong> DATA_LENGTH = createField(DSL.name("DATA_LENGTH"), SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINTUNSIGNED)), this, "");
     ...
     */
    public final TableField<Record, ULong> INDEX_LENGTH = createField(DSL.name("INDEX_LENGTH"), SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINTUNSIGNED)), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.DATA_FREE</code>.
     */
    public final TableField<Record, ULong> DATA_FREE = createField(DSL.name("DATA_FREE"), SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINTUNSIGNED)), this, "");
     ...
     */
    public final TableField<Record, String> PARTITION_COMMENT = createField(DSL.name("PARTITION_COMMENT"), SQLDataType.VARCHAR(80).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.PARTITIONS.NODEGROUP</code>.
     */
    public final TableField<Record, String> NODEGROUP = createField(DSL.name("NODEGROUP"), SQLDataType.VARCHAR(12).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");
    ...
    private Partitions(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private Partitions(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> Partitions(Table<O> child, ForeignKey<O, Record> key) {
