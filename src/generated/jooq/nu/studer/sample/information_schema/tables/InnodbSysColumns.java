...
public class InnodbSysColumns extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> MTYPE = createField(DSL.name("MTYPE"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>information_schema.INNODB_SYS_COLUMNS.PRTYPE</code>.
     */
    public final TableField<Record, Integer> PRTYPE = createField(DSL.name("PRTYPE"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>information_schema.INNODB_SYS_COLUMNS.LEN</code>.
     */
    public final TableField<Record, Integer> LEN = createField(DSL.name("LEN"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "");

    private InnodbSysColumns(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private InnodbSysColumns(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> InnodbSysColumns(Table<O> child, ForeignKey<O, Record> key) {
