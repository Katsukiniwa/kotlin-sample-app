...
open class InnodbFtDefaultStopword(
    ...
    companion object {
         ...
         */
        val INNODB_FT_DEFAULT_STOPWORD = InnodbFtDefaultStopword()
    }
     ...
     */
    val VALUE: TableField<Record, String?> = createField(DSL.name("value"), SQLDataType.VARCHAR(18).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "")
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, INNODB_FT_DEFAULT_STOPWORD, null)
