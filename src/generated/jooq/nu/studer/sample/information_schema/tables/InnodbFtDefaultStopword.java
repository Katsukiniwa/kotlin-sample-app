...
public class InnodbFtDefaultStopword extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> VALUE = createField(DSL.name("value"), SQLDataType.VARCHAR(18).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");

    private InnodbFtDefaultStopword(Name alias, Table<Record> aliased) {
        this(alias, aliased, null);
    }

    private InnodbFtDefaultStopword(Name alias, Table<Record> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> InnodbFtDefaultStopword(Table<O> child, ForeignKey<O, Record> key) {
