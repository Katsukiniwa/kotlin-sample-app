...
open class InnodbFtDeleted(
    ...
    companion object {
         ...
         */
        val INNODB_FT_DELETED = InnodbFtDeleted()
    }
    ...
    constructor(child: Table<out Record>, key: ForeignKey<out Record, Record>): this(Internal.createPathAlias(child, key), child, key, INNODB_FT_DELETED, null)
